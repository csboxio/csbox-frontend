import { c as create_ssr_component, v as validate_component, f as each, e as escape, d as add_attribute } from "../../../../chunks/index2.js";
import { N as Navbar, S as Settings } from "../../../../chunks/Navbar.js";
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `<body class="${"bg-gray-600 antialiased bg-body text-body font-body"}"><div class="${""}">${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})}
    <div class="${"mx-auto lg:ml-20"}"><section><div class="${"pt-5 pb-6 px-8 bg-gray-700"}"><div class="${"flex flex-wrap items-center justify-between -mx-2"}"><div class="${"w-full lg:w-auto px-2 mb-6 lg:mb-0"}"><h4 class="${"text-2xl font-bold text-white tracking-wide leading-7 mb-1"}">Courses</h4></div>
      ...
      return `<a href="${"/dashboard/courses/" + escape(id, true)}" data-sveltekit-preload-data="${"hover"}"><div class="${"mb-8 mx-4"}"><div class="${"min-w-xs max-w-xs "}"><div class="${"relative group "}"><div class="${"absolute group-hover:scale-105 -inset-0.5 bg-gradient-to-r from-gray-400 to-gray-400 rounded-lg blur opacity-0 group-hover:opacity-30 transition duration-1500 group-hover:duration-200"}"></div>
        ...
        0
            ...
            ${course_data.length === 0 ? `<div class="${"flex p-4 mb-12 mt-12 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800"}" role="${"alert"}"><svg aria-hidden="${"true"}" class="${"flex-shrink-0 inline w-5 h-5 mr-3"}" fill="${"currentColor"}" viewBox="${"0 0 20 20"}" xmlns="${"http://www.w3.org/2000/svg"}"><path fill-rule="${"evenodd"}" d="${"M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"}" clip-rule="${"evenodd"}"></path></svg>
                <span class="${"sr-only"}">Info</span>
                <div><span class="${"font-medium"}">No courses found...</span></div></div>` : ``}</div></div></section></div></div></body>`;
  } while (!$$settled);
  return $$rendered;
});
export {
