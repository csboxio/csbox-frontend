  ...
  do {
    ...
    <div class="${"mx-auto lg:ml-20"}"><section><div class="${"pt-5 pb-6 px-8 bg-gray-700"}"><div class="${"flex flex-wrap items-center justify-between -mx-2"}"><div class="${"w-full lg:w-auto px-2 mb-6 lg:mb-0"}"><h4 class="${"text-2xl font-bold text-white tracking-wide leading-7 mb-1"}">Courses</h4></div>
      ...
      {}
        ...
        <section class="${"p-8"}"><div class="${"container m-8"}"><div class="${"flex flex-wrap -mx-12 -mb-6"}">${escape(course_data.course_title)}
                    ${escape(course_data.course_number)}
                    ${escape(course_data.course_prefix)}
                    ${escape(course_data.course_term)}</div></div></section></div></div></body>`;
  } while (!$$settled);
  return $$rendered;
});
export {
