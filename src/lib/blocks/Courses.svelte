...
<Modal title="Join Course" bind:open={joinCourse} class="max-w-xs" >
  <form method="POST" action="?/joinCourse" on:submit|preventDefault={handleSubmit}
        class="flex flex-col items-center justify-center h-full">
    <div class="text-center justify-center text-gray-200 pt-1 pb-4 text-xs inline-block text-center justify-center">
