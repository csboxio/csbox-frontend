...
<div class="container m-6 mx-8">
  ...
  <div class="flex flex-wrap -mx-12 -mb-2">
            ...
            <div transition:blur|local={{ duration: 200 }} id="edit" class="relative z-20">
              ...
              >
                <div class="text-sm text-gray-900 dark:text-white">
                  <div
                    class="p-2 truncate font-bold hover:underline  w-24 cursor-pointer"
                    on:click={() => {
    ...
    {/if}
      {:else}
      <div
              class="flex p-4 ml-6 mb-6 mt-6 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800"
              role="alert"
      >
        <svg
                aria-hidden="true"
        ...
        <span class="sr-only">Info</span>
        <div>
          <span class="font-medium">Error occurred (500) - support@csbox.io</span>
        </div>
      </div>
    {/if}
    {/key}
