...
<div class="z-1 relative">
  <nav class="lg:hidden flex items-center justify-between px-6 py-4 bg-gray-700 mb-0.5">
    <div class="xl:hidden">
      <!-- Navbar-burger on the left -->
      <button class="navbar-burger text-gray-200 hover:text-gray-300 focus:outline-none" on:click={toggleMobileMenu}>
    ...
    <div class="w-full xl:w-auto px-2 xl:mr-12">
      <div class="flex items-center justify-center">
        ...
        <a class="inline-flex items-center h-8" href="#">
          <img class="object-contain" src="/text-whiteAsset%202ldpi.png" width="100" height="100%" alt="">
        </a>
      </div>
    </div>
