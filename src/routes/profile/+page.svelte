        ...
        <div class="flex flex-wrap items-center justify-between -mx-4 mb-8 pb-6 border-b border-gray-400 border-opacity-20">
          ...
          <div class="w-full sm:w-auto px-4">
            <div>
              ...
              <a class="inline-block py-2 px-4 mr-3 text-xs text-center font-semibold leading-normal text-gray-200 bg-gray-600 hover:bg-gray-200 rounded-lg transition duration-200" href="/dashboard">Cancel</a>
              <input class="inline-block py-2 px-4 text-xs text-center font-semibold leading-normal text-gray-200 bg-blue-500 hover:bg-blue-600 rounded-lg transition duration-200" href="/dashboard" type="submit">Save
            </div>
          </div>
        </div>
        <form method="POST" action="?/updateProfile">
              ...
              <div class="max-w-xl">
                <div class="flex flex-wrap items-center -mx-3">
                  <div class="w-full sm:w-1/2 px-3 mb-3 sm:mb-0">
                    <input name="first_name" id="first_name" type="text" class="block py-4 px-3 w-full text-sm text-gray-100 placeholder-gray-100 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-blue-500 rounded-lg" placeholder="" bind:value={userRow.first_name}>
                  </div>
                  <div class="w-full sm:w-1/2 px-3">
                    <input name="last_name" id="last_name" type="text" class="block py-4 px-3 w-full text-sm text-gray-100 placeholder-gray-100 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-blue-500 rounded-lg" placeholder="" bind:value={userRow.last_name}>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="w-full sm:w-2/3 px-4">
              <div class="max-w-xl">
                <div class="relative block px-3 w-full text-sm text-gray-200 placeholder-gray-100 font-medium border border-gray-400 hover:border-white focus-within:border-blue-500 rounded-lg">
                  ...
                  <select name="country" class="w-full py-4 appearance-none bg-transparent outline-none" id="formInput1-6">
          ...
          <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
            <div class="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
              <span name="website" class="text-sm font-medium text-gray-100">Github</span>
            </div>
            <div class="w-full sm:w-2/3 px-4">
              <div class="max-w-xl">
                <input class="block py-4 px-3 w-full text-sm text-gray-100 placeholder-gray-100 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-blue-500 rounded-lg" id="formInput1-8" type="text" placeholder="github.com/example" bind:value={userRow.website}>
              </div>
            </div>
          </div>
