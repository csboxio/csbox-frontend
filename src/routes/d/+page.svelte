                    ...
                    <div class="flex flex-wrap -mx-3 -mb-6">
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                            <div class="max-w-sm mx-auto py-8 px-6 bg-gray-500 rounded-xl drop-shadow-xl">
                                <div class="max-w-xs mx-auto text-center">
                                    <div class="flex mx-auto w-12 h-12 mb-4 items-center justify-center bg-blue-500 bg-opacity-20 text-blue-500 rounded-xl">
                                        <svg fill="none" height="18" viewbox="0 0 22 18" width="22"
                                             xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full lg:w-2/3 px-3 mb-6 lg:mb-0">
                            <div class="p-6 bg-gray-500 rounded-xl drop-shadow-xl">
                                    ...
                                    <div class="w-auto px-4 mb-4">
                                        <div class="flex items-center">
                                            ...
                                            <div class="relative inline-block bg-gray-600 rounded-xl">
                                                <select class="relative py-3 pl-2 pr-6 cursor-pointer bg-transparent text-xs text-gray-300 font-semibold appearance-none outline-none"
                                                        id="" name="" style="z-index: 1;">
                                                    <option value="">Last 7 days</option>
                                                    <option value="">Last Month</option>
                                                </select>
                                                <span class="absolute top-1/2 right-0 mr-2 transform -translate-y-1/2"
                                                      style="z-index: 0;">
                          </span>
                                            </div>
                                        </div>
                                ...
                                <div class="chart mt-8 mb-3 overflow-x-hidden overflow-y-hidden block"
                                     data-type="columns-thin" data-variant="two" style="min-height: 200px;">
                        ...
                        <div class="h-full py-6 px-4 sm:px-6 bg-gray-500 rounded-xl drop-shadow-xl">
                            ...
                            <a class="flex p-4 items-center justify-between hover:bg-gray-600 rounded-xl transition duration-150"
                               href={'#'}>
                                ...
                                <svg fill="none" height="18" viewbox="0 0 4 18" width="4"
                                     xmlns="http://www.w3.org/2000/svg">
