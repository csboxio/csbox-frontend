			...
			<div class="container m-6">
				...
				<div class="flex flex-wrap -mx-12 -mb-2">
					...
					{#if course_data.length === 0}
						<div
							class="flex p-4 ml-6 mb-12 mt-12 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800"
							role="alert"
						>
							<svg
								aria-hidden="true"
