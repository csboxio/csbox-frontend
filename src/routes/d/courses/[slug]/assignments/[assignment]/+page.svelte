...
<div class="flex flex-row">
  <section class="p-1">
    <div class="container mx-1 my-8">
      <h4 class="text-xl font-bold text-white -mx-auto my-5">Title: {assignments.assignment_title}</h4>
      <h4 class="text-xl font-bold text-white -mx-auto my-5">Type: {assignments.category}</h4>
      <h4 class="text-xl font-bold text-white -mx-auto my-5">Description: {assignments.description}</h4>
