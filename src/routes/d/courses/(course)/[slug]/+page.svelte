...
<div class="flex flex-row grow max-w-full-1/2">
    <section class="p-1 grow max-w-full-1/2 ">
        ...
        <div class=" my-6 rounded-lg ">
            ...
            <div class="flex flex space-x-4 grow mr-4 rounded-lg" transition:blur|local="{{duration: 200}}">
                <div class="flex-1 w-1/2 bg-white min-h-screen border-0 rounded-lg"
                     hidden="{mode.edit === true ? '' : 'hidden'}"
                     transition:blur|local="{{duration: 200}}">
                    <div class="editor bg-white" hidden="{mode.edit === true ? '' : 'hidden'}" id="editor"
                         transition:blur|local="{{duration: 200}}"></div>
                </div>
