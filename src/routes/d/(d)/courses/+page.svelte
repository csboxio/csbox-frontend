			...
			<div>
				...
				<Modal title="Join Course" bind:open={defaultModel}>
					<form method="POST" action="?/joinCourse" on:submit|preventDefault={handleSubmit}
						...
						{#if code_invalid}
							<div class="flex p-2 mb-6 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
						...
						{/if}
									<div class="flex items-center justify-between">
										<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-4 rounded focus:outline-none focus:shadow-outline" type="submit">
											Join
										</button>
									</div>
					</form>
