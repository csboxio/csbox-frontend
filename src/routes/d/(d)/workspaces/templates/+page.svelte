        ...
        <div class="pt-3 pb-3 px-8 dark:bg-gray-700 bg-white">
            <div class="flex flex-wrap items-center justify-between -mx-2">
                <div class="w-full lg:w-auto px-2 mb-6 lg:mb-0">
                    <h4 class="text-2xl font-bold dark:text-white  tracking-wide leading-7 mb-1">Workspaces - Templates</h4>
                </div>
            ...
            <div class="flex h-full pb-24 ">
                <div class="m-auto">
                    ...
                    <div class="text-center justify-center text-gray-200 pt-1 text-sm">
                        Create a new template to open in workspaces or assignments.
                    </div>
    ...
    {#if templates}
        ...
        <Table shadow hoverable class="mb-40">
            ...
            <TableBody class="divide-y">
                {#key templates}
                    {#each templates as { id, inserted_at, template_name}}
...
<Modal title="Create Template" bind:open={createTemplate} class="" >
    <div class="text-center px-8">
        <div class="px-4 pb-6 text-white">
            <label class="block mb-2 font-medium text-white dark:text-white">
                Create your template, or pull from git?
            </label>
        </div>
        <div class="font-semibold text-white  pr-4 ">
            ...
            {#if selectedOption === "new"}
                <div class="p-4  space-y-4 mx-auto pt-8 px-16">
                    <div class="space-y-4 ">
