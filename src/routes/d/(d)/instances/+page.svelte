<script lang="ts">
	...
	import TrashCanSolid from "svelte-awesome-icons/TrashSolid.svelte";
		...
		<div class="mx-auto lg:ml-20">
				...
				<div class="pt-5 pb-6 px-8 bg-gray-700">
					<div class="flex flex-wrap items-center justify-between -mx-2">
						<div class="w-full lg:w-auto px-2 mb-6 lg:mb-0">
							<h4 class="text-2xl font-bold text-white tracking-wide leading-7 mb-1">Instances</h4>
						</div>
			...
			<section class="pl-8">
				<div class="container my-4">
					...
					<h4 class="text-xl font-bold text-white -mx-auto mt-8 mb-4 ">Your instances</h4>
						<button
							...
							on:click={() => goto("instances/create")}>
						<span
				...
				<Table shadow hoverable>
					...
					<TableBody class="divide-y">
						{#each instances as { id, inserted_at, instance_config, instance_title, instance_state }}
							<TableBodyRow  class="cursor-pointer" on:click={() => goto("/" + id)}>
