<script lang="ts">
    ...
    let assignments = [ {id: '123', inserted_at: '1/1/2000', assignment_title:'First Python Assignment', user_id:'123-123-123', course_id:'123'} ]
</script>
    ...
    <section class="p-1">
        <div class="container mx-12 my-5">
            ...
            <div class="flex flex-wrap -mx-10 -mb-6 text-white font-semibold">
                ...
                {#each assignments as {id, inserted_at, assignment_title, user_id, course_id }, i}
...
{#if show_create_box}
<!-- Main modal -->
    <div class ="fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 h-full w-full overflow-y-auto overflow-x-hidden">
