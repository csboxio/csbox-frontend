...
<div class="from-blue-900 to-purple-900 bg-gradient-to-tr antialiased bg-body text-body font-body">
  ...
  <section class="py-3">
    <div class="container px-9 mx-auto">
      <div class="min-h-screen flex">
        ...
        <div>
          <div class="p-9 bg-gray-500 rounded-xl">
            <!--Header-->
            <div
            ...
            <div class="w-full sm:w-auto px-4">
              <div>
                ...
                <input
                  ...
                  href="/dashboard/courses" type="submit">
              </div>
            </div>
          </div>
        </div>
