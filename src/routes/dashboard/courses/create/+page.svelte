                  ...
                  <div class="relative group">
                      ...
                      <div>
                          <div class="relative p-6 bg-gray-700  rounded-xl">
                              <img src={course_image_url === undefined || course_image_url === "" ? "https://dummyimage.com/150x150/000/fff" : course_image_url} class="inline-flex items-center justify-center w-20 h-20 mb-6 rounded-lg drop-shadow-2xl"/>
