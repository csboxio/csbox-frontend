                            ...
                            <div class="relative group">
                                ...
                                <div>
                                    <div class="relative p-6 bg-gray-700  rounded-xl">
                                        <img class="inline-flex items-center justify-center w-20 h-20 mb-6 rounded-lg drop-shadow-2xl"
                                             src={course_image_url === undefined || course_image_url === "" ? "https://dummyimage.com/150x150/000/fff" : course_image_url}/>
                                        <a class="inline-block absolute top-1 right-0 m-5 text-gray-300 hover:text-gray-200"
                                           href="#">
                                        ...
                                        <h4 class="text-xl text-white font-bold mb-3">{course_title === undefined || course_title === "" ? "Software Development" : course_title}</h4>
                                        <h4 class="text-xl text-white font-bold mb-1">{course_prefix === undefined || course_prefix === "" ? "CS100" : course_prefix} {course_number === undefined || course_number === "" ? "12345" : course_number}</h4>
                                        <h4 class="text-gray-300 mb-1">{course_term === undefined || course_term === "" ? "Spring 2023" : course_term}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-9 bg-gray-600 rounded-xl">
                            ...
                            <div class="pb-12">
                                <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                                    <div class="bg-blue-600 h-2.5 rounded-full" style="width: {step * 33}%"></div>
                                </div>
                            </div>
                                            ...
                                            <div class="flex flex-wrap items-center -mx-3">
                                                <div class="w-full sm:w-auto px-3 mb-3 sm:mb-0">
                                                    <input name="course_prefix" id="course_prefix" type="text"
                                                           class="block py-4 px-3 w-full text-sm text-gray-100 placeholder-gray-100 font-medium outline-none bg-transparent border border-gray-400 hover:border-white focus:border-blue-500 rounded-lg"
                                                           placeholder="CS100" bind:value={course_prefix}>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
