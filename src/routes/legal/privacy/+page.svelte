...
13.2 Arizona Revised Statutes § 44-1371 et seq. (Arizona Consumer Privacy Act): This act governs the collection, use, and disclosure of personal information by businesses operating in Arizona. It provides consumers with certain rights regarding their personal information and imposes obligations on businesses for handling and securing that information.

13.3 Arizona Revised Statutes § 44-7501 et seq. (Arizona Data Breach Notification Law): This law requires businesses to notify individuals if there has been a security breach that compromises their personal information. It outlines the definition of a breach, the timeline for notification, and the content of the notification.
